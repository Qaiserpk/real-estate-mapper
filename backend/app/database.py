...
def init_db():
    ...
    with engine.connect() as conn:
        ...
        conn.execute(text("ALTER TABLE plots ADD COLUMN IF NOT EXISTS attrs json"))
        conn.execute(text("ALTER TABLE societies ADD COLUMN IF NOT EXISTS hierarchy json"))
